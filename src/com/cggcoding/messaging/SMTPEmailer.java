package com.cggcoding.messaging;
...
public class SMTPEmailer {
	...
	/*public void sendMail(){
		final String username = "cgridley@cggcoding.com";//TODO use constant here
		//final String username = "your_user_name@gmail.com";
        final String password = "Do!tRight13";
        ...
        try {
            ...
            message.setFrom(new InternetAddress("cgridley@cggcoding.com"));//TODO use constant here
            message.setRecipients(Message.RecipientType.TO,
                InternetAddress.parse("cgridley@gmail.com"));
