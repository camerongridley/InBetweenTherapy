...
public class Stage implements Completable {
	...
	private Stage (int stageID, String name, String description, int order){
	...
	public static Stage getInstanceAndCreateID(String name, String description, int order){
		int stageID = Math.abs(new Random(10000).nextInt()); //TODO replace this with a db call that then return the autogenerated stage ID
