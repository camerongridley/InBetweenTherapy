...
public class Stage implements Completable {
	...
	private boolean inProgress;//TODO implement inProgress - add logic to update it appropriately

	
	private Stage (int stageID, String name, String description, int index){
	...
	public static Stage getInstance(int stageID, String name, String description, int order){
		return new Stage(stageID, name, description, order);
	}

	public static Stage getInstanceAndCreateID(String name, String description, int order){
