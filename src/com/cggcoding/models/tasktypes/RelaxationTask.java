...
public class RelaxationTask extends Task implements Updateable{
	...
	public RelaxationTask(int taskID, int userID, int taskSetID, String name, String instructions, int duration) {
		super(taskID, userID, taskSetID, name, instructions);
		durationInMinutes = duration;
	}

	//static factory method
	public static RelaxationTask newInstance(int taskSetID, String name, String instructions, int durationInMinutes){
		...
		return new RelaxationTask(taskID, taskSetID, name, instructions, durationInMinutes);
	}
